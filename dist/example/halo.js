...
(function() {
  ...
  const nama = __createReactive("Arena");
  // @karsa-source 3:1 BuatStatement
  const __el_1 = document.createElement("h1");
  __el_1.innerText = ("Selamat Datang di " + nama.value);
  document.body.appendChild(__el_1);
  // @karsa-source 4:1 SaatStatement
  __watch(nama, (nilaiBaru, nilaiLama) => {
    document.querySelector("h1").innerText = ("Selamat Datang di " + nama.value);
    alert("Nama telah berubah!");
  });
})();