...
// === User Code ===
(function() {
  // @karsa-source 2:1 KomponenDeclaration
  function __komp_Kartu(nama) {
    // Component: Kartu
    const __root = document.createElement("div");
    const __el_1 = document.createElement("div");
    __el_1.id = "kartu";
    const __el_2 = document.createElement("h1");
    __el_2.innerText = nama;
    __el_1.appendChild(__el_2);
    __root.appendChild(__el_1);
    return __root;
  }
  window.Kartu = __komp_Kartu;
  // @karsa-source 6:1 GunakanStatement
  const __komp_3 = __komp_Kartu({ "nama": "KARSA" });
  document.body.appendChild(__komp_3);
})();
