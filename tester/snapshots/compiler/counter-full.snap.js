...
(function() {
  ...
  // @karsa-source 4:1 BuatStatement
  const __el_1 = document.createElement("div");
  __el_1.id = "app";
  const __el_2 = document.createElement("p");
  __el_2.id = "angka";
  __el_2.innerText = hitungan.value;
  __el_1.appendChild(__el_2);
  const __el_3 = document.createElement("button");
  __el_3.id = "tambah";
  __el_3.innerText = "+";
  __el_1.appendChild(__el_3);
  document.body.appendChild(__el_1);
  // @karsa-source 8:1 KetikaStatement
  document.querySelector("tombol#tambah").addEventListener("click", (event) => {
    __setState(hitungan, hitungan.value + 1);
  });
  // @karsa-source 11:1 SaatStatement
